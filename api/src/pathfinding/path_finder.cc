...
std::vector<sf::Vector2f> PathFinder::ConstructPath(const PathPoint& exit_point)
{
...
Path PathFinder::CalculatePath(std::vector<sf::Vector2f> positions, sf::Vector2f start, sf::Vector2f end, int tile_map_offset)
{
